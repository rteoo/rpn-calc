# Historical engineering notes — captured 2026-09-07

This snapshot preserves the project contract at commit 2e0e804, including earlier
bug narratives and Windows size/timing measurements. Those measurements were
not rerun on 2026-09-07. This is historical evidence, not active instructions;
use [AGENTS.md](../../AGENTS.md) for the current contract and
[the verification record](../verification/2026-09-07.md) for current checks.
